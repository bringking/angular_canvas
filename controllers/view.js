...
module.exports = ["$scope", "$element", "$attrs", "$document", function( $scope, $element, $attrs, $document ) {
    ...
    /**
     * Register a child in the layout
     * @param layout
     */
    this.registerChild = layout => {
    ...
    this.computeLayout = () => {
        return flex(
            {style: {padding: 50}, children: children}
        );
    };
    /**
